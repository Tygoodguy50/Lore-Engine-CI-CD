...
import (
	...
	_ "github.com/mudler/LocalAI/pkg/oci_test"

	l "github.com/mudler/LocalAI/pkg/oci"

)

var allTests = []testing.InternalTest{

	{"TestContainerBasic", l.TestContainerBasic },

	{"TestContainerImageName", l.TestContainerImageName },
...
func main() {
	if bzltestutil.ShouldWrap() {
		err := bzltestutil.Wrap("github.com/mudler/LocalAI/pkg/oci")
